...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function toggleContent(projectId) {
        const iconImg = document.getElementById(`section_thirth-content_body_submain_subtitle_icon_img_${projectId}`);
        const content = document.getElementById(`section_thirth-content_body_submain_${projectId}`);

        // Check the current state and toggle
        if (iconImg.src.includes('Plus.svg')) {
            // Change the icon to Minus
            iconImg.src = './assets/thirth-section/Icons/Minus.svg';
            ...
            iconImg.src = './assets/thirth-section/Icons/Plus.svg';
    ...
    projects.forEach(projectId => {
        const icon = document.getElementById(`section_thirth-content_body_submain_subtitle_icon_${projectId}`);
        if (icon) {
    ...
    style.innerHTML = `
        .section_thirth-content_body_submain {
            max-height: 0;
            overflow: hidden;
            opacity: 0;
...
//fifth
  ...
  try {
    const swiper = new Swiper("#section_fifth-content-body_albums_list_cover_img-project1", {
      slidesPerView: 3, // จำนวนภาพที่แสดงพร้อมกัน
      spaceBetween: 6, // ช่องว่างระหว่างภาพ
      navigation: {
        nextEl: "#arrow_right-project1", // ปุ่มเลื่อนขวา
        prevEl: "#arrow_left-project1", // ปุ่มเลื่อนซ้าย
      },
  ...
  document.addEventListener("DOMContentLoaded", () => {
  try {
    const swiper = new Swiper("#section_fifth-content-body_albums_list_cover_img-project2", {
      slidesPerView: 3, // จำนวนภาพที่แสดงพร้อมกัน
      spaceBetween: 6, // ช่องว่างระหว่างภาพ
      navigation: {
        nextEl: "#arrow_right-project2", // ปุ่มเลื่อนขวา
        prevEl: "#arrow_left-project2", // ปุ่มเลื่อนซ้าย
      },
      loop: false, // ไม่วนกลับไปจุดเริ่มต้น
      grabCursor: true, // เปลี่ยน cursor เป็นแบบลากได้
      watchOverflow: true, // ป้องกันปัญหา overflow
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    // Function to toggle content visibility
    function toggleContent(projectId) {
        const iconImg = document.getElementById(`section_sixth-content_body_box-layout_work_icon_${projectId}`);
        const content = document.getElementById(`section_sixth-content_body_box-work_group_${projectId}`);

        // Check the current state and toggle
        if (iconImg.src.includes('Plus.svg')) {
            // Change the icon to Minus
            iconImg.src = './assets/sixth-section/Icons/Minus.svg';
            ...
            // Change the icon to Plus
            iconImg.src = './assets/sixth-section/Icons/Plus.svg';
    ...
    // Add event listeners for all projects
    projects.forEach(projectId => {
        const icon = document.getElementById(`section_sixth-content_body_box-layout_work_icon_${projectId}`);
        if (icon) {
            icon.addEventListener('click', () => toggleContent(projectId));
        }
    });
    ...
    const style = document.createElement('style');
    style.innerHTML = `
        .section_sixth-content_body_box-work_group {
            max-height: 0;
            overflow: hidden;
            opacity: 0;
            transition: max-height 0.5s ease, opacity 0.5s ease;
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    const projects = [
        { class: 'graphic', imgGroupId: 'section_sixth-content_body_box-work_design_img_group' },
        { class: 'web', imgGroupId: 'section_sixth-content_body_box-work_web_img_group' },
        { class: 'mobile', imgGroupId: 'section_sixth-content_body_box-work_mobile_img_group' },
        { class: 'presentation', imgGroupId: 'section_sixth-content_body_box-work_presentation_img_group' },
        { class: '3d', imgGroupId: 'section_sixth-content_body_box-work_3d_img_group' },
        { class: 'painting', imgGroupId: 'section_sixth-content_body_box-work_painting_img_group' }
    ];
    ...
    function initializeSwiper(project) {
        try {
            ...
            const slides = document.querySelectorAll(`#section_sixth-content_body_box-work_group_${project.class} .swiper-slide`);
            const allImages = document.querySelectorAll(`.section_sixth-content_body_box-layout_work_tag_mini_box img`);
  ...
  // Youtube
  document.addEventListener("DOMContentLoaded", () => {
    const playGroup = document.querySelector('.section_seventh-content-body_play_group');
...
document.addEventListener("DOMContentLoaded", () => {
  const videoFrame = document.getElementById("section_seventh-content-body_video");
  const playButtons = document.querySelectorAll("[id^=section_seventh-content-body_play]");

  // Map of play button IDs to video URLs
  const videoMap = {
    "section_seventh-content-body_play1": "https://www.youtube.com/embed/3jx-jb665fY?si=-8EsACtllSp_lhQY",
    "section_seventh-content-body_play2": "https://www.youtube.com/embed/6uInlUbbfq8?si=PeCDPoG96B6Ftuf4",
    "section_seventh-content-body_play3": "https://www.youtube.com/embed/8coGvKhCrSc?si=mdQtrS2prJcToA4I",
    "section_seventh-content-body_play4": "https://www.youtube.com/embed/1i8-vuHsOGg?si=pePg1cf_jfA_CJGW",
    "section_seventh-content-body_play5": "https://www.youtube.com/embed/TQJMXmKvYZk?si=Ij0U4GgosqXibL1M",
    "section_seventh-content-body_play6": "https://www.youtube.com/embed/A_D5Z6g1ft8?si=hSM7fZ9F6sVJrwXx",
  };
  ...
  const initialButton = document.getElementById("section_seventh-content-body_play1");
  if (initialButton) {
...
document.addEventListener("DOMContentLoaded", () => {
  try {
    const swiper = new Swiper("#section_seventh-content-body_albums_list_cover_img-onepiece", {
...
document.addEventListener("DOMContentLoaded", () => {
  try {
    const swiper = new Swiper("#section_seventh-content-body_albums_list_cover_img-dragonball", {
      slidesPerView: 5, // จำนวนภาพที่แสดงพร้อมกัน
      spaceBetween: 6, // ช่องว่างระหว่างภาพ
      navigation: {
...
document.addEventListener("DOMContentLoaded", () => {
  try {
    const swiper = new Swiper("#section_seventh-content-body_albums_list_cover_img-naruto", {
      slidesPerView: 5, // จำนวนภาพที่แสดงพร้อมกัน
      spaceBetween: 6, // ช่องว่างระหว่างภาพ
      navigation: {
